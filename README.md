...
Social VR is a code base that modifies a [Mozilla Hubs](https://hubs.mozilla.com/) room via [code injection]() in order to provide experimental tools for VR meetings. To learn more about the tools, go to the [Social Superpowers website](https://socialsuperpowers.net/).
