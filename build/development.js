  ...
  AFRAME.registerComponent("socialvr-barge", {
    ...
    _startBarge(senderId, dataType, data, targetId) {
      ...
      if (positions.length >= 1) {
        ...
        positions.push(new three.Vector3(8.48, 0, 0.67));
        positions.push(new three.Vector3(8.48, 0, 14.67));
        positions.push(new three.Vector3(-3.51, 0, 14.67));
        positions.push(new three.Vector3(-3.51, 0, 24.67));
      }
